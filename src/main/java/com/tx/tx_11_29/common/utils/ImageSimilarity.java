...
public class ImageSimilarity {
    ...
    public static double calSimilarity(URL url, URL url2) throws IOException {
        return calSimilarity(getHammingDistance(url, url2));
    }
    ...
    public static int getHammingDistance(URL url, URL url2) throws IOException {
        return getHammingDistance(getHash(url), getHash(url2));
    }
     ...
     * @throws IOException
     */
    public static int getHammingDistance(InputStream inputStream, InputStream inputStream2) throws IOException {
        return getHammingDistance(getHash(inputStream), getHash(inputStream2));
    }
    ...
    public static void main(String[] args) throws IOException {
        URL url = new URL("http://192.168.4.9/images/ebayori/AS/AS00176A1.jpg");
        URL url2 = new URL("http://192.168.4.9/images/ebayori/AS/AS00176A1-2.jpg");
        System.out.println(ImageSimilarity.calSimilarity(url, url2));

        URL url3 = new URL("http://192.168.4.9/images/ebayori/AS/AS00176A1.jpg");
        URL url4 = new URL("http://192.168.4.9/images/highori/AS/AS00176A1.jpg");
        System.out.println(ImageSimilarity.calSimilarity(url, url2));
    }
}
